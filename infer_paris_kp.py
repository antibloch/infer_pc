...
def run_semantic_segmentation(ply_path, output_folder="./output"):
    ...
    cfg_file = "ml3d/configs/kpconv_parislille3d.yml"
    ...
    dummy_dataset = ml3d.datasets.ParisLille3D(
        dataset_path="./dummy",
        use_cache=False
    )
    ...
    randlanet_url = "https://storage.googleapis.com/open3d-releases/model-zoo/kpconv_parislille3d_202011241550utc.pth"
    ...
    o3d.io.write_point_cloud(os.path.join(output_folder, "segmented_paris_kp.ply"), segmented_pcd)

    # Save the label dictionary
    with open(os.path.join(output_folder, "dic_paris_kp.json"), "w") as f:
