...
def run_semantic_segmentation(ply_path, output_folder="./output"):
    ...
    o3d.io.write_point_cloud(os.path.join(output_folder, "segmented_paris_randlanet.ply"), segmented_pcd)

    # Save the label dictionary
    with open(os.path.join(output_folder, "dic_paris_randlanet.json"), "w") as f:
